...
badd +0 term:///mnt/d/Code/LatexMarkdown//9261:/bin/bash
badd +0 ./examples/test.lmark
badd +0 examples/lmarkhome.lmark
badd +0 examples/lmarkhome.tex
argglobal
%argdel
$argadd main.cpp
set stal=2
...
setlocal fdn=20
setlocal fen
let s:l = 61 - ((42 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
